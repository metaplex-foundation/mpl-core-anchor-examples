...
#[derive(Accounts)]
pub struct ApproveCollectionPluginAuthorityV1<'info> {
...
impl<'info> ApproveCollectionPluginAuthorityV1<'info> {
    pub fn handler(
        ctx: Context<ApproveCollectionPluginAuthorityV1>,
        args: ApproveCollectionPluginAuthorityV1Args,
    ) -> Result<()> {
        mpl_core::instructions::ApproveCollectionPluginAuthorityV1Cpi {
            ...
            __args: mpl_core::instructions::ApproveCollectionPluginAuthorityV1InstructionArgs {
